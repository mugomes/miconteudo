...
if (CleanGET('acao') == 'excluir') {
    if (!emptyGET('id')) {
        ...
        redirect('/adm/dashboard/post/list.php');
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Lista de Postagens | MiConteudo</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/adm/dashboard/post/edit.php" class="btn btn-success">Nova Postagem</a>
                                    <hr>
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><a href="/adm/dashboard/post/edit.php?id=<?php echo $db1->row('id'); ?>"><?php echo $db1->row('titulo'); ?></a></td>
                                                    ...
                                                    <td><a href="/adm/dashboard/post/editor.php?id=<?php echo $db1->row('id'); ?>" class="btn btn-success">Editor</a> <a href="#" onclick="excluirRegistro('<?php echo $db1->row('id'); ?>');" class="btn btn-danger">Excluir</a></td>
                                                </tr>
                                            <?php }
    ...
    <script>
        function excluirRegistro(id) {
            if (confirm('Deseja realmente excluir esse registro?')) {
                window.location.assign('/adm/dashboard/post/list.php?acao=excluir&id=' + id);
            }
        }
    </script>
</body>
