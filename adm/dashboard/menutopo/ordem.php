...
function menus(int $parent, int $level = 1)
{
...
<head>
    ...
    <title>Organizar Menus | MiConteudo</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/adm/dashboard/menutopo/list.php" class="btn btn-success">Lista de Menus</a>
                                    <hr>
                                    <h3 class="card-title">Organizar Menus</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
        ...
        $(document).ready(function() {
            var updateOutput = function(e) {
                ...
                if (window.JSON) {
                    ...
                    $.post('/adm/dashboard/menutopo/saveordem.php', {
                            'output': output.val()
                        },
                        function(data) {
