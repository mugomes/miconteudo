...
if (CleanGET('acao') == 'excluir') {
    if (!emptyGET('id')) {
        ...
        redirect('/adm/dashboard/menutopo/list.php');
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Lista de Menu Topo | MiConteudo</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/adm/dashboard/menutopo/edit.php" class="btn btn-success">Novo Menu</a>
                                    <a href="/adm/dashboard/menutopo/ordem.php" class="btn btn-success">Organizar</a>
                                    <hr>
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><a href="/adm/dashboard/menutopo/edit.php?id=<?php echo $db1->row('id'); ?>"><?php echo $db1->row('nome'); ?></a></td>
                                                    <td><?php echo $db1->row('link'); ?></td>
                                                    <td><a href="#" onclick="excluirRegistro('<?php echo $db1->row('id'); ?>');" class="btn btn-danger">Excluir</a></td>
                                                </tr>
                                            <?php }
    ...
    <script>
        function excluirRegistro(id) {
            if (confirm('Deseja realmente excluir esse registro?')) {
                window.location.assign('/adm/dashboard/menutopo/list.php?acao=excluir&id=' + id);
            }
        }
    </script>
</body>
