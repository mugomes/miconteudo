...
if (CleanGET('acao') == 'excluir') {
    if (!emptyGET('id')) {
        ...
        redirect('/adm/dashboard/categories/list.php');
    }
}
?>
<!DOCTYPE html>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/adm/dashboard/categories/edit.php" class="btn btn-success">Nova Categoria</a> 
                                    <a href="/adm/dashboard/categories/ordem.php" class="btn btn-success">Organizar</a>
                                    <hr>
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><a href="/adm/dashboard/categories/edit.php?id=<?php echo $db1->row('id'); ?>"><?php echo $db1->row('titulo'); ?></a></td>
    ...
    <script>
        function excluirRegistro(id) {
            if (confirm('Deseja realmente excluir esse registro?')) {
                window.location.assign('/adm/dashboard/categories/list.php?acao=excluir&id=' + id);
            }
        }
    </script>
</body>
