...
if (requestPOST()) {
    if (emptyPOST('txtTitulo')) {
        windowAlert('Digite um título para sua página.');
    } else {
...
<head>
    ...
    <title>Editar Página | MiConteudo</title>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <a href="/adm/dashboard/page/list.php" class="btn btn-success">Lista de Páginas</a>
                                    <hr>
