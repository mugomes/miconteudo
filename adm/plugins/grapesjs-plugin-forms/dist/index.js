            ...
            !(function (e) {
                ...
                t.addType(n, {
                    ...
                    model: {
                        defaults: {
                            ...
                            droppable: ":not(form)",
                            draggable: ":not(form)",
                            attributes: { method: "get", style: "min-height:30px;" },
                            traits: [
                                {
                                    type: "select",
                                    name: "method",
                    ...
                    t.addType(o, {
                        ...
                        model: {
                            defaults: {
                                ...
                                traits: [d, u, { type: "select", name: "type", options: [{ value: "text" }, { value: "email" }, { value: "password" }, { value: "number" }] }, m],
                            },
                        },
                    ...
                    t.addType(i, {
                        ...
                        model: { defaults: { tagName: "select", droppable: !1, highlightable: !1, components: [h("opt1", "Option 1"), h("opt2", "Option 2")], traits: [d, { name: "options", type: "select-options" }, m] } },
                    ...
                    t.addType(s, {
                        ...
                        model: { defaults: { copyable: !1, attributes: { type: "checkbox" }, traits: [{ name: "id" }, d, { name: "value" }, m, { type: "checkbox", name: "checked" }] } },
                        view: {
                            events: { click: v },
                            init: function () {
                ...
                (function (e) {
                    e.TraitManager.addType("select-options", {
                        ...
                        onValueChange: function () {
                            for (var e, t = this.model, n = this.target, o = t.get("value").trim().split("\n"), a = [], i = 0; i < o.length; i++) {
                                var s = o[i].split("::");
                                a.push({ type: l, components: s[1] || s[0], attributes: { value: s[0] } });
                            }
                            n.components().reset(a), null === (e = n.view) || void 0 === e || e.render();
                        },
                        getInputEl: function () {
                            if (!this.$input) {
                ...
                (function (e, t) {
                    var l = t,
                        ...
                        m = function (e, n) {
                            var o;
                            (null === (o = l.blocks) || void 0 === o ? void 0 : o.indexOf(e)) >= 0 && u.add(e, d(d(d({}, n), { category: l.category, select: !0 }), t.block(e)));
                        };
                    m(n, {
                        label: "Form",
                        media:
